...
//     document.getElementById("navigate__header__path-tile").textContent =
//       folderId === "0" ? "Bookmarks" : nodes[0]?.parentTitle || "Folder";
//     document.getElementById("navigate__header__back-button").style.display =
...
// document
//   .getElementById("navigate__header__back-button")
...
//   chrome.bookmarks.search(query, async (results) => {
//     list.innerHTML = "";
...
//       const path = await getBookmarkPath(node.parentId);
//       const pathElem = document.createElement("div");
//       pathElem.className = "item-path";
//       pathElem.textContent = path || "Bookmarks";
//       div.appendChild(pathElem);
